Ext.define('NG.Game', {
        ...
        me.on({
            ...
            join : function(joinCell, joinCount) {
                if(joinCell.gameObject.number >= me.curLevel + 6) {
                    ...
                    var oToRemove = me.oCurRandomNums.childAt(0);
                    console.log('Number', newRandomNum);
                    oToRemove.setName('Number' + newRandomNum);
                    oToRemove.removeMe();
                    me.oCurRandomNums.add(oToRemove);
    ...
    showNext : function(lastCell, gameStart) {
        ...
        var oNum = this.randomNumberObject(cell.row, cell.col, true);
